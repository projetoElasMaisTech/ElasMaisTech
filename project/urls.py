...
from core.views import home, login_user, logout_user, pratique, user_submit, courses, pratique
...
urlpatterns = [
    ...
    path('home/', home),
    path('home/logout_user', logout_user),
    ...
    path('home/pratique/', pratique, name="pratique")
] 
